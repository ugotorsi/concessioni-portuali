...
## 2. Contesto
Stiamo sviluppando una piattaforma per monitoraggio e governo istruttorio delle concessioni portuali.
...
"Esegui un audit severo del progetto Concessioni Portuali, gia consegnato come cloud demo investitore, ma ora da trasformare in piattaforma reale pilotabile. Distingui con nettezza moduli demo vs moduli realmente pronti, assegna voto demo/pilot/production, indica Sprint 1 prioritario, rischi tecnici/legali/commerciali bloccanti, roadmap 30/60/90 giorni, costi stimati, quick wins, cose da tagliare, e raccomandazione finale go/no-go. Mantieni tono pragmatico, non compiacente, orientato a PA e investitore."