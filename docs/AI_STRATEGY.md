...
- L AI e un supporto istruttorio interno, non un decisore.
- Ogni output deve essere validato da un responsabile umano.
- Nessun automatismo provvedimentale verso esterno.
