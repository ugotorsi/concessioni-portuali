...
| Upload documenti locali | Baseline storage locale con metadati e controlli MIME/dimensione | Medio-Alto | Alta | Definire antivirus/malware scanning, policy classificazione, retention allegati e cifratura storage |
| Metadati protocollo/PEC | Baseline istruttoria con warning ricevute PEC incomplete, senza integrazione provider | Medio-Alto | Alta | Definire integrazione PEC/protocollo ufficiale, policy di valore probatorio e retention ricevute |
