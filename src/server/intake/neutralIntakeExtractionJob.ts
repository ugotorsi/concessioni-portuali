...
export {
  ...
  NEUTRAL_INTAKE_EXTRACTION_PURPOSE,
} from "./neutralIntakeExtractionAdmission";
import { NEUTRAL_INTAKE_EXTRACTION_OPERATION } from "./neutralIntakeExtractionAdmission";
